...
export PDH_ENABLE_PLAYER_PROFILES="${INTEGRATION_PLAYER_PROFILES:-false}"
export ITEST_PLAYER_PROFILES="$PDH_ENABLE_PLAYER_PROFILES"
...
export ITEST_COMPOSE_PROJECT="$PROJECT_NAME"
