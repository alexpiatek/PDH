...
export const canPersistNextHandIntent = (state: {
  currentTableId: string | null | undefined;
  currentPlayerId: string | null | undefined;
  lastKey: { tableId: string; playerId: string } | null;
  ...
  Boolean(
    ...
    state.lastKey?.tableId === state.currentTableId &&
    state.lastKey.playerId === state.currentPlayerId &&
    state.renderedIntent === state.currentIntent
  );
